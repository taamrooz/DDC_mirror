...
void Credits::render()
{
	...
	Engine::RenderTexture(mark_donkers, 500, 450, nullptr);
	Engine::RenderTexture(sjors_ficken, 500, 500, nullptr);
	Engine::RenderTexture(renato_feroce, 500, 550, nullptr);
...
bool Credits::init() {
	...
	mark_donkers = Engine::LoadText("manaspc.ttf", 24, { 255,196,0,255 }, "Mark Donkers");
